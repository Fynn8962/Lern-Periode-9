...
<img src="https://github.com/Fynn8962/Lern-Periode-9/blob/main/images/python_alarm.png" alt="python alarm" width="500" >
...
## Reflexion
Am Anfang dieser Lernperiode habe ich an meiner Bewerbungswebsite (Portfolio) gearbeitet. Da wir für das nur begrenzt Zeit hatten, bin ich nicht ganz fertig geworden. Jedoch habe ich noch genügend Zeit, um diese fertig zu machen. Nach der obligatorischen Arbeit an der Bewerbungswebsite mussten wir ein Projekt für diese Lernperiode anfangen. Ich habe mich dazu entschieden Python besser zu lernen, da wir auch gerade ein Modul mit dem Thema Python behandeln. Ich habe mich dann dazu entschieden eine Uhr zu coden, mit Funktionen wie Timer, Stoppuhr und Wecker. Dies habe ich mit einem GUI-Framework umgesetzt (tkinter). Die Arbeit mit tkinter zu lernen bringt mir wahrscheinlich nicht viel in der Zukunft, aber hat Freude gemacht etwas mit einer Benutzeroberfläche zu erstellen. Ich habe während dem arbeiten an meiner Uhr immer mehr gelernt und konnte somit Funktionen kontinuierlich verbessern. Als Beispiel war es am Anfang nicht möglich den Timer im Hintergrund laufen zu lassen oder man konnte nicht Timer und Stoppuhr gleichzeitig laufen lassen. Ich habe beim Code auch auf die Richtlinien geachtet und dass er z.B einigermassen PEP8 konform ist. Da es sehr viel Code ist, habe ich mit Kommentaren gearbeitet, damit ich während dem arbeiten und debuggen mich besser zurechtfinden konnte. Zwischendurch hatte ich Probleme, da die Arbeit mit Zeitparametern manchmal herausfordern ist, da sich z.B Timer und Stoppuhr gegenseitig nicht beeinflussen, blockieren dürfen. Doch mithilfe von Tutorials und KI habe ich die Probleme, die ich hatte verstanden und konnte diese bereinigen. Ich hatte noch vorgehabt ein Einstellungsfenster zu erstellen, wo man z.B das Theme ändern kann, dies habe ich zeitlich jedoch nicht mehr geschafft. Mit meinem fertigen Projekt bin ich jedoch trotzdem.
